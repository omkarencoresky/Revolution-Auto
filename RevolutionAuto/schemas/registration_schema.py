...
registration_schema = {
    ...
    "properties": {
        "first_name": {
            ...
            "description": "First name must be 3 to 50 characters long and contain only letters."
        },
        "last_name": {
            "type": "string",
            "minLength": 3,
            "maxLength": 50,
            "pattern": "^[a-zA-Z]+$",  # Only alphabets
            "description": "Last name must be 3 to 50 characters long and contain only letters."
        },
        "email": {
            "type": "string",
            "minLength": 10,
            ...
            "description": "Email must be between 10 to 50 characters and in a valid format.. Example."
        },
        "phone_no": {
            "type": "string",
            "minLength": 10,
